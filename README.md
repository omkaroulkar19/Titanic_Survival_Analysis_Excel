...
•	Data Analysis: Utilized Pivot Tables to aggregate data and analyze survival rates across different categories.

•	Data Visualization: Created Pivot Charts (e.g., bar charts, pie charts) to visually represent the findings.
